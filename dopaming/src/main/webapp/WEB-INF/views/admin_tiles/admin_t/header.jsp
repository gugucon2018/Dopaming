<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="container-fluid col-xs-12 col-sm-12 col-md-12">
	   <div class="navbar navbar col-xs-12 col-md-12 col-lg-12">
			<div class="container-fluid">
		     ...
		     <div class="nav navbar-nav m_col">
		     		...
		     		<a class="navbar-brand" id="joinBtn" href="#">쪽지</a>
	...
	<div class="container-fluid col-sm-12 col-md-12">
		...
		<div class="navbar navbar col-xs-12 col-md-12 col-lg-12">
		   ...
		   <ul class="nav navbar-nav">				
			...
			<ul class="nav navbar-nav">				
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">매출관리<span class="caret"></span></a>
					<ul class="dropdown-menu">
			...
			<ul class="nav navbar-nav">				
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">신고관리<span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a class="disabled">최신음악</a></li>
				        <li class="divider"></li>
						<li><a href="#">국내음악</a></li>
